...
- [paldb content rules](memory/paldb-content-rules.md) — no "100%" in prose; which VI names stay English
- [paldb deploy GitHub Pages](memory/paldb-deploy-github-pages.md) — deploy.yml on push main; Settings→Pages→Actions
- [paldb known_combos quote YAML](memory/paldb-known-combos-quote-yaml.md) — unquoted [[ dumps frontmatter into body
- [paldb nested by category](memory/paldb-nested-by-category.md) — pals flat; roamlinks pipe fails in table cells
- [paldb onboarded](memory/paldb-onboarded.md) — Palworld KB, 1st doc repo; MkDocs Material; [[slug]] both-way
