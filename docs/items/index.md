...
|:--:|------|----------|--------|
| ![](../assets/icons/items/wool.png){ .item-icon } | [Wool](wool.md) | material | [Lamball](../pals/lamball.md) drop / ranch |
| ![](../assets/icons/items/lamball-mutton.png){ .item-icon } | [Lamball Mutton](lamball-mutton.md) | food | [Lamball](../pals/lamball.md) drop |
| ![](../assets/icons/items/red-berries.png){ .item-icon } | [Red Berries](red-berries.md) | food | [Cattiva](../pals/cattiva.md) drop |
| ![](../assets/icons/items/egg.png){ .item-icon } | [Egg](egg.md) | food | [Chikipi](../pals/chikipi.md) drop / ranch |
| ![](../assets/icons/items/chikipi-poultry.png){ .item-icon } | [Chikipi Poultry](chikipi-poultry.md) | food | [Chikipi](../pals/chikipi.md) drop |
| ![](../assets/icons/items/ranch.png){ .item-icon } | [Ranch](ranch.md) | structure | craft (Tech Lv 5) |
| ![](../assets/icons/items/crusher.png){ .item-icon } | [Crusher](crusher.md) | structure | craft (Tech Lv 8) |
| ![](../assets/icons/items/wood.png){ .item-icon } | [Wood](wood.md) | material | gather |
| ![](../assets/icons/items/stone.png){ .item-icon } | [Stone](stone.md) | material | gather |
| ![](../assets/icons/items/fiber.png){ .item-icon } | [Fiber](fiber.md) | material | gather (trees) |
| ![](../assets/icons/items/ore.png){ .item-icon } | [Ore](ore.md) | material | mine |
| ![](../assets/icons/items/ingot.png){ .item-icon } | [Ingot](ingot.md) | material | refine from Ore |
| ![](../assets/icons/items/gold-coin.png){ .item-icon } | [Gold Coin](gold-coin.md) | material | craft from Ingot / sell |
| ![](../assets/icons/items/paldium-fragment.png){ .item-icon } | [Paldium Fragment](paldium-fragment.md) | material | craft from Stone / gather |
| ![](../assets/icons/items/meteorite-fragment.png){ .item-icon } | [Meteorite Fragment](meteorite-fragment.md) | material | gather → Crusher → Paldium |
| ![](../assets/icons/items/pal-sphere.png){ .item-icon } | [Pal Sphere](pal-sphere.md) | sphere | craft (CP 7) |
| ![](../assets/icons/items/mega-sphere.png){ .item-icon } | [Mega Sphere](mega-sphere.md) | sphere | craft (CP 14) |
| ![](../assets/icons/items/giga-sphere.png){ .item-icon } | [Giga Sphere](giga-sphere.md) | sphere | craft (CP 20) |
| ![](../assets/icons/items/hyper-sphere.png){ .item-icon } | [Hyper Sphere](hyper-sphere.md) | sphere | craft (CP 27) |
| ![](../assets/icons/items/ultra-sphere.png){ .item-icon } | [Ultra Sphere](ultra-sphere.md) | sphere | craft (CP 33) |
| ![](../assets/icons/items/legendary-sphere.png){ .item-icon } | [Legendary Sphere](legendary-sphere.md) | sphere | craft (CP 38) |
| ![](../assets/icons/items/refined-ingot.png){ .item-icon } | [Refined Ingot](refined-ingot.md) | material | refine Ore + Coal |
...
| ![](../assets/icons/items/coal.png){ .item-icon } | [Coal](coal.md) | material | mine (cave) / Blazamut·Pierdon |
