...
> Thrown to capture Pals. Its highly efficient design lets few Pals escape.

Capture Power **33** · unlocked at Technology Lv **35**.
...
| ![](../assets/icons/items/refined-ingot.png){ .game-icon } | [Refined Ingot](refined-ingot.md) | 3 |
| ![](../assets/icons/items/wood.png){ .game-icon } | [Wood](wood.md) | 10 |
| ![](../assets/icons/items/stone.png){ .game-icon } | [Stone](stone.md) | 10 |
