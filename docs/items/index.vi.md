...
|  | Vật phẩm | Loại | Nguồn |
|:--:|----------|------|-------|
| ![](../assets/icons/items/wool.png){ .item-icon } | [Len](wool.md) | nguyên liệu | [Lamball](../pals/lamball.md) rơi / trang trại |
| ![](../assets/icons/items/lamball-mutton.png){ .item-icon } | [Thịt cừu Lamball](lamball-mutton.md) | thức ăn | [Lamball](../pals/lamball.md) rơi |
| ![](../assets/icons/items/red-berries.png){ .item-icon } | [Red Berries](red-berries.md) | thức ăn | [Cattiva](../pals/cattiva.md) rơi |
| ![](../assets/icons/items/egg.png){ .item-icon } | [Trứng](egg.md) | thức ăn | [Chikipi](../pals/chikipi.md) rơi / trang trại |
| ![](../assets/icons/items/chikipi-poultry.png){ .item-icon } | [Thịt gà Chikipi](chikipi-poultry.md) | thức ăn | [Chikipi](../pals/chikipi.md) rơi |
| ![](../assets/icons/items/ranch.png){ .item-icon } | [Trang trại](ranch.md) | công trình | chế (Tech Lv 5) |
| ![](../assets/icons/items/crusher.png){ .item-icon } | [Crusher](crusher.md) | công trình | chế (Tech Lv 8) |
| ![](../assets/icons/items/wood.png){ .item-icon } | [Gỗ](wood.md) | nguyên liệu | thu thập |
| ![](../assets/icons/items/stone.png){ .item-icon } | [Đá](stone.md) | nguyên liệu | thu thập |
| ![](../assets/icons/items/fiber.png){ .item-icon } | [Sợi thực vật](fiber.md) | nguyên liệu | thu từ cây |
| ![](../assets/icons/items/ore.png){ .item-icon } | [Quặng Đồng](ore.md) | nguyên liệu | đào |
| ![](../assets/icons/items/ingot.png){ .item-icon } | [Thỏi Đồng](ingot.md) | nguyên liệu | nung từ Quặng Đồng |
| ![](../assets/icons/items/gold-coin.png){ .item-icon } | [Đồng Vàng](gold-coin.md) | nguyên liệu | chế từ Thỏi Đồng / bán |
| ![](../assets/icons/items/paldium-fragment.png){ .item-icon } | [Mảnh Paldium](paldium-fragment.md) | nguyên liệu | chế từ Đá / nhặt |
| ![](../assets/icons/items/meteorite-fragment.png){ .item-icon } | [Mảnh Thiên Thạch](meteorite-fragment.md) | nguyên liệu | nhặt → Crusher → Paldium |
| ![](../assets/icons/items/pal-sphere.png){ .item-icon } | [Pal Sphere](pal-sphere.md) | sphere | chế (CP 7) |
| ![](../assets/icons/items/mega-sphere.png){ .item-icon } | [Mega Sphere](mega-sphere.md) | sphere | chế (CP 14) |
| ![](../assets/icons/items/giga-sphere.png){ .item-icon } | [Giga Sphere](giga-sphere.md) | sphere | chế (CP 20) |
| ![](../assets/icons/items/hyper-sphere.png){ .item-icon } | [Hyper Sphere](hyper-sphere.md) | sphere | chế (CP 27) |
| ![](../assets/icons/items/ultra-sphere.png){ .item-icon } | [Ultra Sphere](ultra-sphere.md) | sphere | chế (CP 33) |
| ![](../assets/icons/items/legendary-sphere.png){ .item-icon } | [Legendary Sphere](legendary-sphere.md) | sphere | chế (CP 38) |
| ![](../assets/icons/items/refined-ingot.png){ .item-icon } | [Thỏi Tinh Luyện](refined-ingot.md) | nguyên liệu | luyện Quặng + Than |
...
| ![](../assets/icons/items/coal.png){ .item-icon } | [Than](coal.md) | nguyên liệu | đào (hang) / Blazamut·Pierdon |
...
| ![](../assets/icons/items/high-quality-pal-oil.png){ .item-icon } | [Dầu Pal Cao Cấp](high-quality-pal-oil.md) | nguyên liệu | Pal rơi |
| ![](../assets/icons/items/sulfur.png){ .item-icon } | [Lưu Huỳnh](sulfur.md) | nguyên liệu | đào (núi lửa) / Pierdon |
| ![](../assets/icons/items/gunpowder.png){ .item-icon } | [Thuốc Súng](gunpowder.md) | nguyên liệu | chế (Than Củi + Lưu Huỳnh) |
| ![](../assets/icons/items/charcoal.png){ .item-icon } | [Than Củi](charcoal.md) | nguyên liệu | chế (Gỗ) |
| ![](../assets/icons/items/nail.png){ .item-icon } | [Đinh](nail.md) | nguyên liệu | chế (Thỏi Đồng) |
