...
slug: carrot-plantation
category: structure
code: FarmBlockV2_Carrot
build:
  category: Production
  tech_level: 32
  build_work: 20000
  ingredients:
    ...
    - item: [[aquatic-pal-fluids]]
      qty: 1
operate_suitability: planting, watering, gathering
defense: 2
tags: [item, structure]
---
...
Mở tại **Công nghệ Cấp 32**. Công sức xây: 20000 ([[handiwork|Handiwork]]).
